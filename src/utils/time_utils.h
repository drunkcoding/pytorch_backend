...
#define MCIROSECONDS_SINCE_EPOCH std::chrono::duration_cast<MCIROSECONDS>(TIME_NOW.time_since_epoch()).count()
#define MILLISECONDS_SINCE_EPOCH std::chrono::duration_cast<MILLISECONDS>(TIME_NOW.time_since_epoch()).count()
