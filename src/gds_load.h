...
class GDSLoader {
 public:
  ...
  int loadAsync(const char* filename, int device_id, void** devPtr_p, std::future<ssize_t>& future_p);
  int loadAsyncInited(const char* filename, int device_id, void** devPtr_p, std::future<ssize_t>& future_p);
  bool cudaInit();
